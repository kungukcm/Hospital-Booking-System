...
def book_appointment(person_name: str, appointment_type: str, appointment_year: int, appointment_month: int,
    ...
    try:
        ...
        logger.info(f"✅ Booked: {saved_apt['id']} for {person_name}")
        return response
...
@tool
def cancel_appointment(appointment_id: str = None, person_name: str = None, patient_id: str = None, reason: str = "Patient request", confirm_cancel: bool = False):
    """
